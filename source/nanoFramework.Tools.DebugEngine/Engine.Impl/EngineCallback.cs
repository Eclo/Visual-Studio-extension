...
namespace nanoFramework.Tools.DebugEngine
{
    class EngineCallback //: ISampleEngineCallback
    {
        ...
        public void OnError(int hrErr)
        {
            ...
            // The nanoFramework debug engine doesn't take advantage of this.
        }
        ...
        public void OnModuleLoad(DebuggedModule debuggedModule)
        {
            ...
            // The nanoFramework debug engine does not support binding breakpoints as modules load since the primary exe is the only module
        ...
        public void OnBreakpoint(DebuggedThread thread, ReadOnlyCollection<object> clients, uint address)
        {
            ...
            // The nanoFramework debug engine does not support these features.
        ...
        public void OnException(DebuggedThread thread, uint code)
        {
            ...
            // The nanoFramework debug engine does not support these.
            throw new NotImplementedException();
        }

        public void OnStepComplete(DebuggedThread thread)
        {
            // Step complete is sent when a step has finished. The nanoFramework debug engine does not support stepping.
            throw new NotImplementedException();
        }
