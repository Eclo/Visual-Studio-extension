...
namespace nanoFramework.Tools.DebugEngine
{
    ...
    {       
        ...
        {
            // The nanoFramework debug engine only supports breakpoints on a file and line number. No other types of breakpoints are supported.
        ...
        int IDebugPendingBreakpoint2.Bind()
        {
            try
            {
                ...
                else
                {
                    ...
                    // The nanoFramework debug engine does not support this, but a real world engine will want to send an instance of IDebugBreakpointErrorEvent2 to the
        ...
        int IDebugPendingBreakpoint2.CanBind(out IEnumDebugErrorBreakpoints2 ppErrorEnum)
        {
            ...
            if (!CanBind())
            {
                ...
                // The nanoFramework debug engine does not support this, but a real world engine will want to return a valid enumeration of IDebugErrorBreakpoint2.
        ...
        // The nanoFramework debug engine does not support conditions on breakpoints.
        int IDebugPendingBreakpoint2.SetCondition(BP_CONDITION bpCondition)
        {
            throw new NotImplementedException();
        }

        // The nanoFramework debug engine does not support pass counts on breakpoints.
        ...
        // The nanoFramework debug engine will does not support this.
