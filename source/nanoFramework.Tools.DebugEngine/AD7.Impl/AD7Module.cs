...
namespace nanoFramework.Tools.DebugEngine
{
    ...
    class AD7Module : IDebugModule2, IDebugModule3
    {
        ...
        // The nanoFramework debug engine only supports loading symbols from the location pointed to by the PE file which will load
        ...
        // Used to support the JustMyCode features of the debugger.
        // The nanoFramework debug engine does not support JustMyCode so this is not implemented
