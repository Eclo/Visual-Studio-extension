...
{
    // AD7Engine is the primary entrypoint object for the nanoFramework debug engine. 
    //
    // It implements:
    //
    ...
    public class AD7Engine : IDebugEngine2, IDebugEngineLaunch2, IDebugProgram3, IDebugEngineProgram2, IDebugSymbolSettings100
    {
        ...
        // This object manages breakpoints in the nanoFramework debug engine.
        ...
        {
            DebuggedModule module = new DebuggedModule();// TODOm_debuggedProcess.ResolveAddress(ip);
        ...
        int IDebugEngine2.Attach(IDebugProgram2[] rgpPrograms, IDebugProgramNode2[] rgpProgramNodes, uint celtPrograms, IDebugEventCallback2 ad7Callback, enum_ATTACH_REASON dwReason)
        {
            ...
            try
            {
                ...
                if (processId == 0)
                {
                    return Constants.E_NOTIMPL; // nanoFramework debug engine only supports system processes
                }
        ...
        // was received and processed. The only event the nanoFramework debug engine sends in this fashion is Program Destroy.
        ...
        // The nanoFramework debug engine does not support exceptions in the debuggee so this method is not actually implemented.
        ...
        {
            // The nanoFramework debug engine will always stop on all exceptions.
        ...
        // strings returned by the DE are properly localized. The nanoFramework debug engine is not localized so this is not implemented.
        ...
        {
            // The nanoFramework debug engine does not need to understand any metric settings.
            return Constants.S_OK;
        }
        ...
        {
            // The nanoFramework debug engine does not read settings from the registry.
            return Constants.S_OK;
        }
        ...
        {
            // The nanoFramework debug engine always supports detach
            return Constants.S_OK;
        }
        ...
        public int EnumModules(out IEnumDebugModules2 ppEnum)
        {
            ...
            // TODO
            ppEnum = new nanoFramework.Tools.DebugEngine.AD7ModuleEnum(new AD7Module[0]);
        ...
        public int EnumThreads(out IEnumDebugThreads2 ppEnum)
        {
            ...
            //ppEnum = new nanoFramework.Tools.DebugEngine.AD7ThreadEnum(threadObjects);
            ppEnum = new nanoFramework.Tools.DebugEngine.AD7ThreadEnum(new AD7Thread[0]);
        ...
        // The nanoFramework debug engine does not support this
        ...
        // The nanoFramework debug engine does not support dissassembly so it returns E_NOTIMPL
        ...
        {
            // The nanoFramework debug engine does not participate in managed edit & continue.
            update = null;
            return Constants.S_OK;            
        }
        ...
        {
            engineName = "nanoFramework Debug Engine";
        ...
        {
            // The nanoFramework debug engine uses default transport and doesn't need to customize the name of the program,
            // so return NULL.
            programName = null;
            return Constants.S_OK;
        }
        ...
        {
            // Because the nanoFramework debug engine is a native debugger, it implements IDebugEngineLaunch2, and will terminate
        ...
        //
        // The nanoFramework debug engine only supports debugging native applications and therefore only has one program per-process
        public int Stop()
        {
            throw new NotImplementedException();
        }
        ...
        // the same process. The nanoFramework debug engine doesn't cooperate with other engines, so it has nothing
        // to do here.
        ...
        // The nanoFramework debug engine doesn't cooperate with other engines, so it has nothing to do here.
