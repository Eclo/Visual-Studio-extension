...
namespace nanoFramework.Tools.DebugEngine
{
    ...
    //
    // The nanoFramework debug engine only supports locals and parameters for functions that have symbols loaded.
    class AD7Property : IDebugProperty2
    {
        ...
        // The nanoFramework debug engine does not support obtaining the parent of properties.
