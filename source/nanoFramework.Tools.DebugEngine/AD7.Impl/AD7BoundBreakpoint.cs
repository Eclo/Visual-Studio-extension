...
namespace nanoFramework.Tools.DebugEngine
{
    ...
    class AD7BoundBreakpoint : IDebugBoundBreakpoint2
    {
        ...
        int IDebugBoundBreakpoint2.Enable(int fEnable)
        {
            ...
            {
                // A production debug engine would remove or add the underlying int3 here. The nanoFramework debug engine does not support true disabling
                // of breakpionts.
            }
        ...
        // The nanoFramework debug engine does not support hit counts on breakpoints. A real-world debugger will want to keep track 
