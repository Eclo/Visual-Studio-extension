...
namespace nanoFramework.Tools.DebugEngine
{
    ...
    class AD7StackFrame : IDebugStackFrame2, IDebugExpressionContext2
    {
        ...
        public void SetFrameInfo(enum_FRAMEINFO_FLAGS dwFieldSpec, out FRAMEINFO frameInfo)
        {
            ...
            // For the nanoFramework debug engine, this is the contents of the frame pointer.
        ...
        // The nanoFramework debug engine only supports returning locals and parameters. Other possible values include
